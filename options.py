...
def export_to_notepad(notepad):
    with open('C:/Users/комп/Desktop/СR_PYTHON/notepad.csv', 'a+', encoding='utf-8') as data:
        for item in notepad:
...
def import_to_notepad():
    notepad = dict()        
    with open('C:/Users/комп/Desktop/СR_PYTHON/notepad.csv', 'r', encoding='utf-8') as data:
...
def replace_notepad(messege, new_notepad):
    with open('C:/Users/комп/Desktop/СR_PYTHON/notepad.csv', 'w', encoding='utf-8') as data: 
        print(messege)   
